...
Цей проєкт перевіряє дані з API Svitlobot і надсилає індикацію тенденції вмикання чи вимикання електроенергії для відповідної групи до відповідного користувача, чату, групи чи форуму в Telegram.

## Особливості

- Підключення до клієнта Telegram;
- Перевірка статусу електропостачання у відповідній групі в Києві та відправка індикації тенденції відповідному користувачу, чату, групі чи форуму в Telegram;
...
Базові параметри конфігурації, включаючи облікові дані Ecoflow та Telegram, можуть бути передані як змінні середовища:
...
| `--period-of-fixed-tendency` | | Період у хвилинах, коли тенденція фіксується | `число` | `60` | Ні |
...
Ви можете вказати кілька пар, розділивши їх комами:
...
Через обмеження середовища Docker, додаток не зможе інтерективно запитувати відсутні параметри конфігурації. Тому необхідно виконати перший запуск в інтерактивному режимі, щоб надати відсутні параметри.
